...
@section('content')
    <header>
        <div class="head-content">
            ...
            <a href="#" class="cttn">Learn more</a>
        </div>
    </header>
    <!--Information-->
    <section class="info">
    ...
    <section class="footer">
        <a style=color:white href="http://localhost:8000/about">About</a><br>
        <a style=color:white href="http://localhost:8000/contact">Contact</a><br>
        <p>123 @ COPYRIGHT</p>
    </section>
    <script>
