                        ...
                        <tr class="bg-white border-b">
                            ...
                            <td>
                                <div class="bg-orange-600 hover:bg-orange-700 p-1 text-white rounded text-center shadow-md">
                                    <form method="post" action="{{ url('/admin/housing', $house->id) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
