...
class HousingSearchController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('housingsearch.list', ['housings' => $housings]);
    }
    ...
    {
        return view('housingsearch.create');
    }
...
//        ]);
        ...
        return redirect("/housingsearch")->with('success', 'Housing updated.');;
    }
